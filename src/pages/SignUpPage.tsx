...
const SignUpPage = () => {
  ...
  const handleBasicInfoSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Skip validation and move directly to medical records tab
  ...
  const handleSignUp = () => {
    ...
    if (profile.userType === 'elderly' || profile.userType === 'caretaker') {
            ...
            <form onSubmit={handleBasicInfoSubmit}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <p className="text-gray-600 italic">
                  For demo purposes, no sign up information is required.
                  <br />
                  Just click the "Continue to Medical Records" button below to proceed.
                </p>
              </div>
